...
struct MemoryListener {
     ...
     * @section: The #MemoryRegionSection.
     */
    void (*log_dtrack_sync)(MemoryListener *listener, MemoryRegionSection *section);
    /* ---------------- */
...
/* Added by Samindu */
/**
 * memory_global_dtrack_dirty_log_sync: synchronize the dirty log for all memory to use in dtrack
 *
 * Synchronizes the dirty page log for all address spaces to use in dtrack.
 *
 * @last_stage: whether this is the last stage of live migration
 */
void memory_global_dtrack_dirty_log_sync(bool last_stage);
/* ---------------- */
