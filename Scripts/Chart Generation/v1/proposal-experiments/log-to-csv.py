...
folder = 'S:\\University\\Research\\Undergraduate Research\\MRMPPLM\\Data-and-Logs\\Old-Data\\fake-dirty\\experiment-workbench-data\\Experiments_2024-06-04_1\\'
...
for optimization in os.listdir(folder):
    ...
    if optimization_data != "HBFDP_Murmur3":
        continue
