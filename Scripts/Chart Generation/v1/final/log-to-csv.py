...
folder = 'S:\\University\\Research\\Undergraduate Research\\MRMPPLM\\Data-and-Logs\\Experiment-Data\\final_2025-02-24_3'
...
for workload in os.listdir(f"{folder}"):
    ...
    for optimization in os.listdir(f"{folder}\\{workload}"):
        ...
        # el
        if "HBFDP_PreCopy" in optimization:
            # if "SHA1" in optimization:
            #     optimization_data = "HBFDP_SHA1"
            # el
            if "MD5" in optimization:
