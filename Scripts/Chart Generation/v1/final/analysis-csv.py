...
optimizations = ['Vanilla', 'XBZRLE', 'Compress', 'HBFDP_SHA1', 'HBFDP_MD5', 'HBFDP_Murmur3', 'XBZRLE_HBFDP_SHA1',
                 'XBZRLE_HBFDP_MD5', 'XBZRLE_HBFDP_Murmur3', 'Compress_HBFDP_SHA1', 'Compress_HBFDP_MD5',
                 'Compress_HBFDP_Murmur3', 'Dtrack', 'Compress_Dtrack', 'XBZRLE_Dtrack']
# optimizations = ['Vanilla', 'XBZRLE', 'Compress', 'HBFDP_SHA1', 'Dtrack']
workloads = ['Memcached']
rams = [1, 2, 4, 8, 12, 16]
cells = [3, 5]
average = {
